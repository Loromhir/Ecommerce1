...
const SingUp = () => {
  return (
    <>
      ...
      <button type="button" className="btn btn-outline-primary me-2" data-bs-toggle="modal" data-bs-target="#signUpModal">
            <span className='fa fa-user-plus me-1'></span>  Register
            </button>

            <div className="modal fade" id="signUpModal" tabIndex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            <div className="mb-3 row">
                                ...
                                <button type="submit" className="fa-solid btn btn-outline-primary w-100 mt-3">Register</button>
                            </div>
                        </div>
                    </div>
                </div>
